...
int main(int argc, char** argv)
{
    ...
    generate_argb_image(p_input_image, input_size, 0xFF00FF00); // 0xFFFFFFFF: white, 0xFF0000FF: red, 0xFF00FF00: green
#endif
    }

    printf("Input Image (%ld bytes)\n", input_size);
    saveBufferToFile(p_input_image, input_size, "green_argb8888_32bit_1280x800.raw");
#if (DEBUG_PRINT == 1)
    ...
    saveBufferToFile(p_output_image, write_size, "green_rgb888_24bit_1280x800.raw");
#if (DEBUG_PRINT == 1)
    ...
    saveBufferToFile(p_output_image, write_size, "green_rgb888_32bit_1280x800.raw");
#if (DEBUG_PRINT == 1)
    ...
    saveBufferToFile(p_output_image, write_size, "green_rgb666_24bit_1280x800.raw");
#if (DEBUG_PRINT == 1)
    ...
    saveBufferToFile(p_output_image, write_size, "green_rgb666_32bit_1280x800.raw");
#if (DEBUG_PRINT == 1)
    ...
    saveBufferToFile(p_output_image, write_size, "green_rgb666_18bit_1280x800.raw");
#if (DEBUG_PRINT == 1)
